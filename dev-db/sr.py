...
# and everything thing is taken care of.
try:
...
#RUCKUS = SRP_ROOT_PREFIX + "/usr/src/ruckus"
RUCKUS = "/home/mike/src/srp/testing"

# full path to the srp lock file
LOCK = RUCKUS + "/package/lock"
